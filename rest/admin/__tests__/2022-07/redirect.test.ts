...
describe('Redirect resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:rest/admin/__tests__/2022-07/redirect.test.ts
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/redirect.test.ts
      since_id: "668809255",
    });
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/redirect.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/redirects/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/redirect.test.ts
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-07/redirects/950115854.json',
      query: '',
      headers,
