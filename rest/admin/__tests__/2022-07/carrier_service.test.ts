...
describe('CarrierService resource', () => {
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-07/carrier_services/1036895017.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/carrier_services/1036895021.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-07/carrier_services/1036895020.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
