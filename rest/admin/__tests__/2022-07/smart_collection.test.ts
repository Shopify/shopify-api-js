...
describe('SmartCollection resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:rest/admin/__tests__/2022-07/smart_collection.test.ts
...
=======
  ...
  it('test_2', async () => {
    ...
    await SmartCollection.all({
      session: test_session,
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/smart_collection.test.ts
      since_id: "482865238",
    });
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/smart_collection.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/smart_collections/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/smart_collection.test.ts
  ...
  it('test_20', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-07/smart_collections/482865238/order.json',
