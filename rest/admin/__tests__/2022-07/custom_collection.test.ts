...
describe('CustomCollection resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:rest/admin/__tests__/2022-07/custom_collection.test.ts
...
=======
  ...
  it('test_4', async () => {
    ...
    await CustomCollection.all({
      session: test_session,
      since_id: "841564295",
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-07/custom_collection.test.ts
    });
