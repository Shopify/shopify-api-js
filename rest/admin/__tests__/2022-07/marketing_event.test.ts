...
describe('MarketingEvent resource', () => {
  ...
  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"marketing_event": {"id": 1069063884, "event_type": "ad", "remote_id": null, "started_at": "2023-12-14T19:00:00-05:00", "ended_at": null, "scheduled_to_end_at": null, "budget": null, "currency": null, "manage_url": null, "preview_url": null, "utm_campaign": "Christmas2023", "utm_source": "facebook", "utm_medium": "cpc", "budget_type": null, "description": null, "marketing_channel": "social", "paid": true, "referring_domain": "facebook.com", "breadcrumb_id": null, "marketing_activity_id": 1063897334, "admin_graphql_api_id": "gid://shopify/MarketingEvent/1069063884", "marketed_resources": []}}));
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "marketing_event": {"started_at": "2023-12-15", "utm_campaign": "Christmas2023", "utm_source": "facebook", "utm_medium": "cpc", "event_type": "ad", "referring_domain": "facebook.com", "marketing_channel": "social", "paid": true} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_5', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "marketing_event": {"remote_id": "1000:2000", "started_at": "2023-02-02T00:00 +00:00", "ended_at": "2023-02-03T00:00 +00:00", "scheduled_to_end_at": "2023-02-04T00:00 +00:00", "budget": "11.1", "budget_type": "daily", "currency": "CAD", "utm_campaign": "other", "utm_source": "other", "utm_medium": "other", "event_type": "ad", "referring_domain": "instagram.com"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_7', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: {"engagements": [{"occurred_on": "2023-01-15", "views_count": 0, "clicks_count": 0, "favorites_count": 0, "ad_spend": 10.0, "is_cumulative": true}, {"occurred_on": "2023-01-16", "views_count": 100, "clicks_count": 50, "is_cumulative": true}, {"occurred_on": "2023-01-17", "views_count": 200, "clicks_count": 100, "is_cumulative": true}]}
    }).toMatchMadeHttpRequest();
  });
