...
describe('Webhook resource', () => {
  ...
  it('test_1', async () => {
    queueMockResponse(JSON.stringify({"webhooks": [{"id": 1014196360, "address": "https://example.org/app_uninstalled", "topic": "app/uninstalled", "created_at": "2022-10-03T12:44:45-04:00", "updated_at": "2022-10-03T12:44:45-04:00", "format": "json", "fields": [], "metafield_namespaces": [], "api_version": "unstable", "private_metafield_namespaces": []}]}));
  ...
  it('test_5', async () => {
    queueMockResponse(JSON.stringify({"webhook": {"id": 4759306, "address": "https://apple.com", "topic": "orders/create", "created_at": "2022-10-03T12:44:45-04:00", "updated_at": "2022-10-03T12:44:45-04:00", "format": "json", "fields": [], "metafield_namespaces": [], "api_version": "unstable", "private_metafield_namespaces": []}}));
  ...
  it('test_6', async () => {
    queueMockResponse(JSON.stringify({"webhook": {"id": 4759306, "address": "https://somewhere-else.com/", "topic": "orders/create", "created_at": "2022-10-03T12:44:45-04:00", "updated_at": "2022-10-03T12:55:11-04:00", "format": "json", "fields": [], "metafield_namespaces": [], "api_version": "unstable", "private_metafield_namespaces": []}}));
  ...
  it('test_8', async () => {
    queueMockResponse(JSON.stringify({"webhook": {"id": 7226364925, "address": "pubsub://projectName:topicName", "topic": "customers/update", "created_at": "2022-10-03T12:59:17-04:00", "updated_at": "2022-10-03T12:59:17-04:00", "format": "json", "fields": [], "metafield_namespaces": [], "api_version": "unstable", "private_metafield_namespaces": []}}));
  ...
  it('test_9', async () => {
    queueMockResponse(JSON.stringify({"webhook": {"id": 7226364934, "address": "https://example.hostname.com/", "topic": "orders/create", "created_at": "2022-10-03T13:00:26-04:00", "updated_at": "2022-10-03T13:00:26-04:00", "format": "json", "fields": ["id", "note"], "metafield_namespaces": [], "api_version": "unstable", "private_metafield_namespaces": []}}));
