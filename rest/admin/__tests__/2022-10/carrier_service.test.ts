...
describe('CarrierService resource', () => {
  ...
  it('test_1', async () => {
    queueMockResponse(JSON.stringify({"carrier_service": {"id": 1036894957, "name": "Shipping Rate Provider", "active": true, "service_discovery": true, "carrier_service_type": "api", "admin_graphql_api_id": "gid://shopify/DeliveryCarrierService/1036894957", "format": "json", "callback_url": "http://shipping.example.com/"}}));
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"carrier_service": {"active": false, "id": 1036894955, "name": "Some new name", "service_discovery": true, "carrier_service_type": "api", "admin_graphql_api_id": "gid://shopify/DeliveryCarrierService/1036894955", "format": "json", "callback_url": "http://example.com/"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-10/carrier_services/1036894955.json',
      query: '',
      headers,
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-10/carrier_services/1036894959.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
