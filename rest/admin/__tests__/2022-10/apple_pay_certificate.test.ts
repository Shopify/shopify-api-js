...
import {ApplePayCertificate} from '../../2022-01';
...
describe('ApplePayCertificate resource', () => {
  ...
  it('test_1', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"apple_pay_certificate": {"id": 1068938279, "status": "issuing", "merchant_id": null}}));
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-01/apple_pay_certificates.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"apple_pay_certificate": {"id": 1068938280, "status": "csr", "merchant_id": null}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-01/apple_pay_certificates/1068938280.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"apple_pay_certificate": {"id": 1068938282, "status": "completed", "merchant_id": "merchant.something"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-01/apple_pay_certificates/1068938282.json',
      query: '',
      headers,
<<<<<<< HEAD:rest/admin/__tests__/2022-10/apple_pay_certificate.test.ts
...
=======
      data: { "apple_pay_certificate": {"id": 1068938282, "status": "completed", "merchant_id": "merchant.something", "encoded_signed_certificate": "\nKoZIzj0CAQYIKoZIzj0DAQcDQgAEAxDDCvzG6MnsZSJOtbr0hr3MRq 4HzTZ\\nhvdjZAUBMIH MIHDBggrBgEFBQcCAjCBtgyBs1JlbGlhbmNlIG9uIHRoaXMg\\nNKpVyn3t\n"} }
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2022-01/apple_pay_certificate.test.ts
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-01/apple_pay_certificates/1068938283.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-01/apple_pay_certificates/1068938281/csr.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
