...
describe('FulfillmentOrder resource', () => {
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000813.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000816/cancel.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000823/close.json',
      query: '',
      headers,
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000810/move.json',
      query: '',
      headers,
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000821/open.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000819/reschedule.json',
      query: '',
      headers,
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000815/hold.json',
      query: '',
      headers,
