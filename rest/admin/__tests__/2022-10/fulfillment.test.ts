...
describe('Fulfillment resource', () => {
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-10/fulfillment_orders/1046000784/fulfillments.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillments/1069019878/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_13', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-10/fulfillments/1069019867/cancel.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
