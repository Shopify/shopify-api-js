...
***********************************************************************************************************************/
<<<<<<< HEAD:rest/admin/__tests__/2022-04/article.test.ts
=======

import {Session} from '../../../auth/session';
import {Context} from '../../../context';
import {ApiVersion} from '../../../base-types';
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-04/article.test.ts
...
<<<<<<< HEAD:rest/admin/__tests__/2022-04/article.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/blogs/241253187/articles.json',
      query: '',
      headers,
      data: undefined
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-04/article.test.ts
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/blogs/241253187/articles/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
...
=======
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/blogs/241253187/articles/134645308.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-04/article.test.ts
  ...
  it('test_18', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/articles/authors.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-04/article.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/articles/tags.json',
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-04/article.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/blogs/241253187/articles/tags.json',
      query: 'limit=1&popular=1',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
