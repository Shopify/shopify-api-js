...
describe('MobilePlatformApplication resource', () => {
  ...
  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066175998, "application_id": "X1Y2.ca.domain.app", "platform": "ios", "created_at": "2022-10-03T13:14:13-04:00", "updated_at": "2022-10-03T13:14:13-04:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true}}));
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066175999, "application_id": "com.example", "platform": "android", "created_at": "2022-10-03T13:14:16-04:00", "updated_at": "2022-10-03T13:14:16-04:00", "sha256_cert_fingerprints": ["14:6D:E9:83:C5:73:06:50:D8:EE:B9:95:2F:34:FC:64:16:A0:83:42:E6:1D:BE:A8:8A:04:96:B2:3F:CF:44:E5"], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": false}}));
  ...
  it('test_4', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066175996, "application_id": "X1Y2.ca.domain.app", "platform": "ios", "created_at": "2022-10-03T13:14:05-04:00", "updated_at": "2022-10-03T13:14:05-04:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true}}));
  ...
  it('test_5', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"application_id": "A1B2.ca.domain.app", "platform": "ios", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true, "id": 1066175997, "created_at": "2022-10-03T13:14:07-04:00", "updated_at": "2022-10-03T13:14:08-04:00"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-04/mobile_platform_applications/1066175997.json',
      query: '',
      headers,
