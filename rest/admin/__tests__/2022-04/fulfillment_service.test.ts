...
describe('FulfillmentService resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/fulfillment_services.json',
      query: 'scope=all',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"fulfillment_service": {"id": 1061774487, "name": "Jupiter Fulfillment", "email": null, "service_name": "Jupiter Fulfillment", "handle": "jupiter-fulfillment", "fulfillment_orders_opt_in": false, "include_pending_stock": false, "provider_id": null, "location_id": 1072404544, "callback_url": "http://google.com/", "tracking_support": true, "inventory_management": true, "admin_graphql_api_id": "gid://shopify/ApiFulfillmentService/1061774487"}}));
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/fulfillment_services/755357713.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
