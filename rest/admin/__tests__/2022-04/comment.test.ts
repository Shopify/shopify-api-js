...
describe('Comment resource', () => {
  ...
  it('test_9', async () => {
    queueMockResponse(JSON.stringify({"comment": {"author": "Your new name", "body": "You can even update through a web service.", "email": "your@updated-email.com", "published_at": "2023-06-14T14:19:29-04:00", "id": 118373535, "body_html": "<p>You can even update through a web service.</p>", "status": "published", "article_id": 134645308, "blog_id": 241253187, "created_at": "2023-06-14T14:13:28-04:00", "updated_at": "2023-06-14T14:19:30-04:00", "ip": "127.0.0.1", "user_agent": "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_4; en-us) AppleWebKit/525.18 (KHTML, like Gecko) Version/3.1.2 Safari/525.20.1"}}));
    ...
    comment.published_at = "2023-06-14T18:19:29.872Z";
    await comment.save({});
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "comment": {"body": "You can even update through a web service.", "author": "Your new name", "email": "your@updated-email.com", "published_at": "2023-06-14T18:19:29.872Z"} }
    }).toMatchMadeHttpRequest();
  });

  it('test_10', async () => {
    queueMockResponse(JSON.stringify({"comment": {"id": 757536351, "body": "I like comments\nAnd I like posting them *RESTfully*.", "body_html": "<p>I like comments<br>\nAnd I like posting them <strong>RESTfully</strong>.</p>", "author": "Your name", "email": "your@email.com", "status": "pending", "article_id": 134645308, "blog_id": 241253187, "created_at": "2023-06-14T14:19:48-04:00", "updated_at": "2023-06-14T14:19:48-04:00", "ip": "107.20.160.121", "user_agent": null, "published_at": null}}));
