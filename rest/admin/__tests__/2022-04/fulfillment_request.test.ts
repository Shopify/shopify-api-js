...
describe('FulfillmentRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-04/fulfillment_orders/1046000809/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-04/fulfillment_orders/1046000810/fulfillment_request/accept.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-04/fulfillment_orders/1046000811/fulfillment_request/reject.json',
      query: '',
      headers,
