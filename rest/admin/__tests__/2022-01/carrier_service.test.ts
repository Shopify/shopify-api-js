...
describe('CarrierService resource', () => {
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-01/carrier_services/1067451815.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-01/carrier_services/1067451816.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-01/carrier_services/1067451812.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
