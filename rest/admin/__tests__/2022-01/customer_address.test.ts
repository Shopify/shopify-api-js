...
describe('CustomerAddress resource', () => {
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-01/customers/207119551/addresses/1053317288.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-01/customers/207119551/addresses/set.json',
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-01/customers/207119551/addresses/1053317289/default.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
