...
describe('MobilePlatformApplication resource', () => {
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066176000, "application_id": "X1Y2.ca.domain.app", "platform": "ios", "created_at": "2023-01-03T12:42:54-05:00", "updated_at": "2023-01-03T12:42:54-05:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true, "enabled_app_clips": false, "app_clip_application_id": null}}));
  ...
  it('test_4', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066175998, "application_id": "X1Y2.ca.domain.app", "platform": "ios", "created_at": "2023-01-03T12:42:49-05:00", "updated_at": "2023-01-03T12:42:49-05:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true, "enabled_app_clips": false, "app_clip_application_id": null}}));
  ...
  it('test_6', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "mobile_platform_application": {"application_id": "A1B2.ca.domain.app", "platform": "ios", "created_at": "2023-01-03T12:42:58-05:00", "updated_at": "2023-01-03T12:42:58-05:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true, "enabled_app_clips": false, "app_clip_application_id": null} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2023-01/mobile_platform_applications/1066176001.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
