...
describe('ResourceFeedback resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "resource_feedback": {"state": "requires_action", "messages": ["is not connected. Connect your account to use this sales channel."], "feedback_generated_at": "2023-02-02T15:00:51.956827Z"} }
    }).toMatchMadeHttpRequest();
  });

  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"resource_feedback": {"created_at": "2023-02-02T10:00:54-05:00", "updated_at": "2023-02-02T10:00:54-05:00", "resource_id": 548380009, "resource_type": "Shop", "resource_updated_at": null, "messages": [], "feedback_generated_at": "2023-02-02T10:00:53-05:00", "state": "success"}}));
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "resource_feedback": {"state": "success", "feedback_generated_at": "2023-02-02T15:00:53.508619Z"} }
    }).toMatchMadeHttpRequest();
  });
