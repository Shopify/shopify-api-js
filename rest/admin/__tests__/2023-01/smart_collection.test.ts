...
describe('SmartCollection resource', () => {
  ...
  it('test_1', async () => {
    queueMockResponse(JSON.stringify({"smart_collections": [{"id": 1063001314, "handle": "ipods-1", "title": "IPods", "updated_at": "2023-07-05T18:38:37-04:00", "body_html": null, "published_at": "2023-07-05T18:38:37-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "title", "relation": "starts_with", "condition": "iPod"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001314"}]}));
  ...
  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"smart_collections": [{"id": 482865238, "handle": "smart-ipods", "title": "Smart iPods", "updated_at": "2008-02-01T19:00:00-05:00", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2023-07-05T18:38:03-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1688596683"}}]}));
  ...
  it('test_4', async () => {
    queueMockResponse(JSON.stringify({"smart_collections": [{"id": 1063001315, "handle": "macbooks", "title": "Macbooks", "updated_at": "2023-07-05T18:38:38-04:00", "body_html": null, "published_at": "2023-07-05T18:38:38-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001315"}, {"id": 482865238, "handle": "smart-ipods", "title": "Smart iPods", "updated_at": "2008-02-01T19:00:00-05:00", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2023-07-05T18:38:03-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1688596683"}}]}));

    await shopify.rest.SmartCollection.all({
      session: session,
      ids: "482865238,1063001315",
    });
    ...
    expect({
      ...
      domain,
      path: '/admin/api/2023-01/smart_collections.json',
      query: 'ids=482865238%2C1063001315',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_9', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "id": 482865238, "published_at": "2023-07-05T18:39:01-04:00", "updated_at": "2023-07-05T18:39:01-04:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2023-07-05T18:38:03-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1688596683"}}}));
  ...
  it('test_10', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "smart_collection": {"image": "", "updated_at": "2023-07-05T18:38:42-04:00", "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238"} }
    }).toMatchMadeHttpRequest();
  });

  it('test_11', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"updated_at": "2023-07-05T18:38:59-04:00", "id": 482865238, "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2023-07-05T18:38:59-04:00", "alt": "Rails logo", "width": 110, "height": 140, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1688596739"}}}));
  ...
  it('test_12', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"updated_at": "2023-07-05T18:38:50-04:00", "id": 482865238, "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"alt": "Rails logo", "created_at": "2023-07-05T18:38:49-04:00", "width": 110, "height": 140, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20230705-19607-55plro.gif?v=1688596730"}}}));
  ...
  it('test_15', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"id": 1063001318, "handle": "macbooks", "title": "Macbooks", "updated_at": "2023-07-05T18:38:46-04:00", "body_html": null, "published_at": "2023-07-05T18:38:46-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001318", "image": {"created_at": "2023-07-05T18:38:46-04:00", "alt": "iPod", "width": 1, "height": 1, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/df3e567d6f16d040326c7a0ea29a4f41.gif?v=1688596726"}}}));
  ...
  it('test_16', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"id": 1063001319, "handle": "macbooks", "title": "Macbooks", "updated_at": "2023-07-05T18:38:51-04:00", "body_html": null, "published_at": "2023-07-05T18:38:50-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001319", "image": {"created_at": "2023-07-05T18:38:51-04:00", "alt": "Rails Logo", "width": 110, "height": 140, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20230705-19607-27hlwp.gif?v=1688596731"}}}));
  ...
  it('test_17', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"id": 1063001317, "handle": "macbooks", "title": "Macbooks", "updated_at": "2023-07-05T18:38:45-04:00", "body_html": null, "published_at": null, "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001317"}}));
  ...
  it('test_18', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"id": 1063001322, "handle": "ipods-1", "title": "IPods", "updated_at": "2023-07-05T18:38:57-04:00", "body_html": null, "published_at": "2023-07-05T18:38:57-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "title", "relation": "starts_with", "condition": "iPod"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001322"}}));
  ...
  it('test_19', async () => {
    queueMockResponse(JSON.stringify({"smart_collection": {"id": 1063001323, "handle": "macbooks", "title": "Macbooks", "updated_at": "2023-07-05T18:39:00-04:00", "body_html": null, "published_at": "2023-07-05T18:39:00-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001323"}}));
