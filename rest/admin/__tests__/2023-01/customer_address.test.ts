...
describe('CustomerAddress resource', () => {
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2023-01/customers/207119551/addresses/1053317306.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      ...
      query: 'address_ids%5B%5D=1053317305&operation=destroy',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2023-01/customers/207119551/addresses/1053317304/default.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
