...
describe('FulfillmentOrder resource', () => {
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000820.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000814/cancel.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000810/close.json',
      query: '',
      headers,
  ...
  it('test_5', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "fulfillment_order": {"new_location_id": 655441491, "fulfillment_order_line_items": [{"id": 1058738351, "quantity": 1}]} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000809/open.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000816/reschedule.json',
      query: '',
      headers,
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000821/hold.json',
      query: '',
      headers,
      data: {"fulfillment_hold": {"reason": "inventory_out_of_stock", "reason_notes": "Not enough inventory to complete this work.", "fulfillment_order_line_items": [{"id": 1058737538, "quantity": 1}]}}
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_9', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: {"fulfillment_order_ids": [1046000811], "fulfillment_deadline": "2021-05-26T10:00:00-04:00"}
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-04/fulfillment_orders/1046000812/release_hold.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
