...
***********************************************************************************************************************/
<<<<<<< HEAD:rest/admin/__tests__/2023-04/custom_collection.test.ts
=======

import {Session} from '../../../auth/session';
import {Context} from '../../../context';
import {ApiVersion} from '../../../base-types';
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-01/custom_collection.test.ts
...
=======
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-01/custom_collections.json',
      query: '',
      headers,
      data: null
...
=======
  it('test_11', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-01/custom_collections/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-01/custom_collection.test.ts
    ...
    await shopify.rest.CustomCollection.count({
      session: session,
    });
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2023-04/custom_collections/841564295.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
...
=======
  it('test_13', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-01/custom_collections/841564295.json',
      query: '',
      headers,
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/__tests__/2022-01/custom_collection.test.ts
  ...
  it('test_16', async () => {
    ...
    await shopify.rest.CustomCollection.delete({
      session: session,
      id: 841564295,
    });
