...
describe('GiftCardAdjustment resource', () => {
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"adjustment": {"id": 1064273909, "gift_card_id": 1035197676, "api_client_id": 755357713, "user_id": null, "order_transaction_id": null, "number": 1, "amount": "10.00", "processed_at": "2023-02-02T09:30:31-05:00", "created_at": "2023-02-02T09:30:31-05:00", "updated_at": "2023-02-02T09:30:31-05:00", "note": "Customer refilled gift card by $10", "remote_transaction_ref": null, "remote_transaction_url": null}}));
  ...
  it('test_4', async () => {
    queueMockResponse(JSON.stringify({"adjustment": {"id": 1064273910, "gift_card_id": 1035197676, "api_client_id": 755357713, "user_id": null, "order_transaction_id": null, "number": 1, "amount": "-20.00", "processed_at": "2023-02-02T09:30:33-05:00", "created_at": "2023-02-02T09:30:33-05:00", "updated_at": "2023-02-02T09:30:33-05:00", "note": "Customer spent $20 via external service", "remote_transaction_ref": null, "remote_transaction_url": null}}));
  ...
  it('test_5', async () => {
    queueMockResponse(JSON.stringify({"adjustment": {"id": 1064273911, "gift_card_id": 1035197676, "api_client_id": 755357713, "user_id": null, "order_transaction_id": null, "number": 1, "amount": "10.00", "processed_at": "2022-08-02T09:30:33-04:00", "created_at": "2023-02-02T09:30:33-05:00", "updated_at": "2023-02-02T09:30:33-05:00", "note": null, "remote_transaction_ref": null, "remote_transaction_url": null}}));
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "adjustment": {"amount": 10.0, "processed_at": "2022-08-02T09:30:33-04:00"} }
    }).toMatchMadeHttpRequest();
  });
