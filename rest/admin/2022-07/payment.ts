...
export class Payment extends Base {
  ...
  protected static resourceNames: string[] = ['payment'];
  protected static pluralNames: string[] = ['payments'];
  ...
  protected static paths: ResourcePath[] = [
    {
      ...
      operation: 'count',
      ids: ['checkout_id'],
      path: 'checkouts/<checkout_id>/payments/count.json',
    },
    {
      http_method: 'get',
      operation: 'get',
      ids: ['checkout_id'],
      path: 'checkouts/<checkout_id>/payments.json',
    },
    {
      http_method: 'get',
      operation: 'get',
      ids: ['checkout_id', 'id'],
      path: 'checkouts/<checkout_id>/payments/<id>.json',
    },
    {
      http_method: 'post',
      operation: 'post',
  ...
  public static async all({
    ...
    checkout_id = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<Payment>> {
