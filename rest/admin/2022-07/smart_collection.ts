...
export class SmartCollection extends Base {
  ...
  protected static resourceNames: string[] = ['smart_collection'];
  protected static pluralNames: string[] = ['smart_collections'];
  ...
  protected static paths: ResourcePath[] = [
    {
      ...
      operation: 'delete',
      ids: ['id'],
      path: 'smart_collections/<id>.json',
    },
    {
      http_method: 'get',
      operation: 'count',
    ...
    },
    {
      ...
      operation: 'order',
      ids: ['id'],
      path: 'smart_collections/<id>/order.json',
    },
    {
      http_method: 'put',
      operation: 'put',
  ...
  public static async find({
    ...
    id,
    fields = null,
  }: FindArgs): Promise<SmartCollection | null> {
  ...
  public static async all({
    ...
    fields = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<SmartCollection>> {
