...
export class Report extends Base {
  ...
  protected static resourceNames: string[] = ['report'];
  protected static pluralNames: string[] = ['reports'];
  ...
  public static async all({
    ...
    fields = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<Report>> {
