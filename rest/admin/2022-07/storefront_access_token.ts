...
export class StorefrontAccessToken extends Base {
  ...
  protected static resourceNames: string[] = ['storefront_access_token'];
  protected static pluralNames: string[] = ['storefront_access_tokens'];
  ...
  protected static paths: ResourcePath[] = [
    {
      ...
      operation: 'delete',
      ids: ['id'],
      path: 'storefront_access_tokens/<id>.json',
    },
    {
      http_method: 'get',
      operation: 'get',
  ...
  public static async all({
    session,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<StorefrontAccessToken>> {
