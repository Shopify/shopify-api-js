...
export class ScriptTag extends Base {
  ...
  protected static resourceNames: string[] = ['script_tag'];
  protected static pluralNames: string[] = ['script_tags'];
  ...
  public static async find({
    ...
    id,
    fields = null,
  }: FindArgs): Promise<ScriptTag | null> {
  ...
  public static async all({
    ...
    fields = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<ScriptTag>> {
