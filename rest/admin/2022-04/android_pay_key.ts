...
export class AndroidPayKey extends Base {
  ...
  protected static resourceNames: string[] = ['android_pay_key'];
  protected static pluralNames: string[] = ['android_pay_keys'];
  ...
  public static async find({
    session,
    id,
  }: FindArgs): Promise<AndroidPayKey | null> {
