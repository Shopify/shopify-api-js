...
export class Redirect extends Base {
  ...
  protected static resourceNames: string[] = ['redirect'];
  protected static pluralNames: string[] = ['redirects'];
  ...
  protected static paths: ResourcePath[] = [
    {
      ...
      operation: 'delete',
      ids: ['id'],
      path: 'redirects/<id>.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: [],
      path: 'redirects/count.json',
    },
  ...
  public static async find({
    ...
    id,
    fields = null,
  }: FindArgs): Promise<Redirect | null> {
