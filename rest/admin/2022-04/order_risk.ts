...
export class OrderRisk extends Base {
  ...
  protected static resourceNames: string[] = ['risk'];
  protected static pluralNames: string[] = ['risks'];
  ...
  protected static paths: ResourcePath[] = [
    {
      ...
      operation: 'delete',
      ids: ['order_id', 'id'],
      path: 'orders/<order_id>/risks/<id>.json',
    },
    {
      http_method: 'get',
      operation: 'get',
  ...
  public static async find({
    ...
    id,
    order_id = null,
  }: FindArgs): Promise<OrderRisk | null> {
  ...
  public static async all({
    ...
    order_id = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<OrderRisk>> {
