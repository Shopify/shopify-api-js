...
export class CustomCollection extends Base {
  ...
  protected static resourceNames: string[] = ['custom_collection'];
  protected static pluralNames: string[] = ['custom_collections'];
  ...
  public static async find({
    ...
    id,
    fields = null,
  }: FindArgs): Promise<CustomCollection | null> {
  ...
  public static async all({
    ...
    fields = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<CustomCollection>> {
