...
export class CollectionListing extends Base {
  ...
  protected static resourceNames: string[] = ['collection_listing'];
  protected static pluralNames: string[] = ['collection_listings'];
  ...
  protected static paths: ResourcePath[] = [
    {
      ...
      operation: 'delete',
      ids: ['collection_id'],
      path: 'collection_listings/<collection_id>.json',
    },
    {
      http_method: 'get',
      operation: 'get',
      ids: [],
      path: 'collection_listings.json',
    },
    {
      http_method: 'get',
      operation: 'get',
    ...
    },
    {
      ...
      ids: ['collection_id'],
      path: 'collection_listings/<collection_id>/product_ids.json',
    },
    {
      http_method: 'put',
      operation: 'put',
  ...
  public static async find({
    session,
    collection_id,
  }: FindArgs): Promise<CollectionListing | null> {
  ...
  public static async all({
    ...
    limit = null,
    ...otherArgs
  }: AllArgs): Promise<FindAllResponse<CollectionListing>> {
