...
<<<<<<< HEAD:rest/admin/2022-04/marketing_event.ts
...
>>>>>>> 1a149a83 (Add 2022-10 REST resources):src/rest-resources/2022-01/marketing_event.ts
...
=======
  ...
  protected static PATHS: ResourcePath[] = [
    ...
    {"http_method": "delete", "operation": "delete", "ids": ["id"], "path": "marketing_events/<id>.json"},
    {"http_method": "post", "operation": "engagements", "ids": ["id"], "path": "marketing_events/<id>/engagements.json"}
>>>>>>> origin/isomorphic/main:src/rest-resources/2022-01/marketing_event.ts
  ];
