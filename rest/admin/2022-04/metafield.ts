...
export class Metafield extends Base {
  ...
  protected static resourceNames: string[] = ['metafield'];
  protected static pluralNames: string[] = ['metafields'];
  ...
  protected static paths: ResourcePath[] = [
    ...
    },
    {
      ...
      operation: 'count',
      ids: ['article_id'],
      path: 'articles/<article_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['blog_id'],
      path: 'blogs/<blog_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
    ...
    },
    {
      ...
      operation: 'count',
      ids: ['collection_id'],
      path: 'collections/<collection_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['customer_id'],
      path: 'customers/<customer_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['draft_order_id'],
      path: 'draft_orders/<draft_order_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
    ...
    },
    {
      ...
      operation: 'count',
      ids: ['order_id'],
      path: 'orders/<order_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['page_id'],
      path: 'pages/<page_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['product_image_id'],
      path: 'product_images/<product_image_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['product_id'],
      path: 'products/<product_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'count',
      ids: ['variant_id'],
      path: 'variants/<variant_id>/metafields/count.json',
    },
    {
      http_method: 'get',
      operation: 'get',
      ids: ['article_id'],
      path: 'articles/<article_id>/metafields.json',
    },
    {
      http_method: 'get',
      operation: 'get',
