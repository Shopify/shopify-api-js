...
<<<<<<< HEAD:rest/admin/2023-04/smart_collection.ts
...
>>>>>>> upstream/v5:src/rest-resources/2022-04/smart_collection.ts
...
=======
  ...
  protected static PATHS: ResourcePath[] = [
    ...
    {"http_method": "delete", "operation": "delete", "ids": ["id"], "path": "smart_collections/<id>.json"},
    {"http_method": "put", "operation": "order", "ids": ["id"], "path": "smart_collections/<id>/order.json"}
>>>>>>> origin/isomorphic/main:src/rest-resources/2021-07/smart_collection.ts
  ];
