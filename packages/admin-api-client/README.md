...
| getHeaders    | `(headers?: {[key: string]: string}) => {[key: string]: string`                                                                                                       | Returns Admin API specific headers needed to interact with the API. If `headers` is provided, the custom headers will be included in the returned headers object.                                                                                                                                                                                               |
