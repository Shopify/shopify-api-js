...
describe('DraftOrder resource', () => {
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-01/draft_orders/994118539.json',
      query: '',
      headers,
  ...
  it('test_14', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2024-01/draft_orders/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2024-01/draft_orders/994118539/send_invoice.json',
      query: '',
      headers,
  ...
  it('test_17', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2024-01/draft_orders/994118539/complete.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
