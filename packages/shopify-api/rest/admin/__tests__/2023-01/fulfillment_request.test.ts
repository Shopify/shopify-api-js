...
describe('FulfillmentRequest resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-01/fulfillment_orders/1046000829/fulfillment_request.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2023-01/fulfillment_orders/1046000828/fulfillment_request/accept.json',
      query: '',
      headers,
