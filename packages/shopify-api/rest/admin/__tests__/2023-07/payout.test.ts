...
describe('Payout resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2023-07/shopify_payments/payouts.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2023-07/shopify_payments/payouts/623721858.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
