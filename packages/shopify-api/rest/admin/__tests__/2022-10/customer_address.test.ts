...
describe('CustomerAddress resource', () => {
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-10/customers/207119551/addresses/1053317314.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      ...
      query: 'address_ids%5B%5D=1053317315&operation=destroy',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_9', async () => {
    ...
    const customer_address = new shopify.rest.CustomerAddress({session: session});
    customer_address.customer_id = 207119551;
    customer_address.id = 1053317312;
    await customer_address.default({});

    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-10/customers/207119551/addresses/1053317312/default.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
