...
describe('ApplePayCertificate resource', () => {
  ...
  it('test_1', async () => {
    queueMockResponse(JSON.stringify({"apple_pay_certificate": {"id": 1068938277, "status": "issuing", "merchant_id": null}}));
  ...
  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"apple_pay_certificate": {"id": 1068938278, "status": "csr", "merchant_id": null}}));
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-04/apple_pay_certificates/1068938275.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/apple_pay_certificates/1068938274/csr.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
