...
- ⚠️ [Breaking] Add REST resources for July 2022 API version, add `Shopify.LATEST_API_VERSION` constant, remove support and REST resources for July 2021 (`2021-07`) API version [#415](https://github.com/Shopify/shopify-node-api/pull/415)
