...
export const testSuite = [
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({path: '/url/path/403'}),
      expectedResponse: initTestResponse({
        statusCode: 403,
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({path: '/url/path/404'}),
      expectedResponse: initTestResponse({
        statusCode: 404,
        statusText: 'Did not work',
        errorType: 'HttpResponseError',
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({path: '/url/path/429'}),
      expectedResponse: initTestResponse({
        statusCode: 429,
        statusText: 'Did not work',
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({path: '/url/path/500'}),
      expectedResponse: initTestResponse({
        statusCode: 500,
        statusText: 'Did not work',
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({
        ...
        extraHeaders: {'X-Not-A-Real-Header': 'some_value'},
      }),
      expectedResponse: initTestResponse({
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({
        ...
        extraHeaders: {'User-Agent': 'My agent'},
      }),
      expectedResponse: initTestResponse({
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({
        ...
        extraHeaders: {'user-agent': 'My lowercase agent'},
      }),
      expectedResponse: initTestResponse({
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({
        path: '/url/path/retrythensuccess',
        tries: 2,
  ...
  },
  {
    ...
    config: {
      testRequest: initTestRequest({path: 'url/path'}),
      expectedResponse: initTestResponse(),
    },
  },
  {
