...
import {CustomerAddress} from '../../2022-10';
...
describe('CustomerAddress resource', () => {
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-10/customers/207119551/addresses/1053317293.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2022-10/customers/207119551/addresses/1053317290/default.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
