...
describe('Balance resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:src/rest-resources/__tests__/2022-10/balance.test.ts
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-04/balance.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-10/shopify_payments/balance.json',
      query: '',
      headers,
      data: null
