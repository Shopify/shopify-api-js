...
describe('Article resource', () => {
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
<<<<<<<< HEAD:src/rest-resources/__tests__/2022-10/article.test.ts
      path: '/admin/api/2022-10/blogs/241253187/articles.json',
========
      path: '/admin/api/2022-07/blogs/241253187/articles.json',
>>>>>>>> upstream/v5:src/rest-resources/__tests__/2022-07/article.test.ts
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
...
>>>>>>>> upstream/v5:src/rest-resources/__tests__/2022-07/article.test.ts
  ...
  it('test_18', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"authors": ["dennis", "John", "Rob", "Dennis"]}));

    await Article.authors({
      session: test_session,
    });
