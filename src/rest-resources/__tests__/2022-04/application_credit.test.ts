...
import {ApplicationCredit} from '../../2022-04';
...
describe('ApplicationCredit resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:src/rest-resources/__tests__/2022-04/application_credit.test.ts
...
=======
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-07/application_credits.json',
      query: '',
      headers,
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-07/application_credit.test.ts
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-04/application_credits.json',
      query: '',
      headers,
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-07/application_credit.test.ts
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-04/application_credits/140583599.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
