...
import {AndroidPayKey} from '../../2022-04';
...
describe('AndroidPayKey resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:src/rest-resources/__tests__/2022-04/android_pay_key.test.ts
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-04/android_pay_key.test.ts
