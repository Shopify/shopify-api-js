...
describe('Payout resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/shopify_payments/payouts.json',
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/shopify_payments/payouts/623721858.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
