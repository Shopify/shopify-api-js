...
describe('AndroidPayKey resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:src/rest-resources/__tests__/2022-07/android_pay_key.test.ts
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-10/android_pay_key.test.ts
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-10/android_pay_key.test.ts
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/android_pay_keys/964811894.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
