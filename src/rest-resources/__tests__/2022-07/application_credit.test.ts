...
describe('ApplicationCredit resource', () => {
  ...
  it('test_1', async () => {
<<<<<<< HEAD:src/rest-resources/__tests__/2022-07/application_credit.test.ts
...
>>>>>>> origin/isomorphic/main:src/rest-resources/__tests__/2021-10/application_credit.test.ts
