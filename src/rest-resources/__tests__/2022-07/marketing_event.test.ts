...
import {MarketingEvent} from '../../2022-07';
...
describe('MarketingEvent resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/marketing_events.json',
      query: '',
      headers,
      data: null
  ...
  it('test_2', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"marketing_event": {"id": 1065859216, "event_type": "ad", "remote_id": null, "started_at": "2022-12-15T03:00:00-05:00", "ended_at": null, "scheduled_to_end_at": null, "budget": null, "currency": null, "manage_url": null, "preview_url": null, "utm_campaign": "Christmas2022", "utm_source": "facebook", "utm_medium": "cpc", "budget_type": null, "description": null, "marketing_channel": "social", "paid": true, "referring_domain": "facebook.com", "breadcrumb_id": null, "marketing_activity_id": 1063897333, "admin_graphql_api_id": "gid://shopify/MarketingEvent/1065859216", "marketed_resources": []}}));
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/marketing_events/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"marketing_event": {"id": 998730532, "event_type": "post", "remote_id": "12345678", "started_at": "2022-01-15T10:56:18-05:00", "ended_at": null, "scheduled_to_end_at": null, "budget": "10.11", "currency": "GBP", "manage_url": null, "preview_url": null, "utm_campaign": "1234567890", "utm_source": "facebook", "utm_medium": "facebook-post", "budget_type": "daily", "description": null, "marketing_channel": "social", "paid": false, "referring_domain": "facebook.com", "breadcrumb_id": null, "marketing_activity_id": null, "admin_graphql_api_id": "gid://shopify/MarketingEvent/998730532", "marketed_resources": []}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-07/marketing_events/998730532.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "marketing_event": {"remote_id": "1000:2000", "started_at": "2022-02-02T00:00 +00:00", "ended_at": "2022-02-03T00:00 +00:00", "scheduled_to_end_at": "2022-02-04T00:00 +00:00", "budget": "11.1", "budget_type": "daily", "currency": "CAD", "utm_campaign": "other", "utm_source": "other", "utm_medium": "other", "event_type": "ad", "referring_domain": "instagram.com"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2022-07/marketing_events/998730532/engagements.json',
      query: '',
      headers,
