...
describe('CarrierService resource', () => {
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-10/carrier_services/1036894964.json',
      query: '',
      headers,
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/carrier_services/1036894966.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2021-10/carrier_services/1036894967.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
