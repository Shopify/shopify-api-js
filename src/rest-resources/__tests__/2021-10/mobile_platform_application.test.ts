...
describe('MobilePlatformApplication resource', () => {
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/mobile_platform_applications/1066176008.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-10/mobile_platform_applications/1066176009.json',
      query: '',
      headers,
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-10/mobile_platform_applications/1066176010.json',
      query: '',
      headers,
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2021-10/mobile_platform_applications/1066176011.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
