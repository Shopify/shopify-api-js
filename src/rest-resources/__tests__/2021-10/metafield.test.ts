...
describe('Metafield resource', () => {
  ...
  it('test_14', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/articles/674387490/metafields.json',
      query: '',
      headers,
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/blogs/382285388/metafields.json',
      query: '',
      headers,
  ...
  it('test_16', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/collections/482865238/metafields.json',
      query: '',
      headers,
  ...
  it('test_17', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/customers/207119551/metafields.json',
      query: '',
      headers,
  ...
  it('test_18', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/draft_orders/622762746/metafields.json',
      query: '',
      headers,
  ...
  it('test_19', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/orders/450789469/metafields.json',
      query: '',
      headers,
  ...
  it('test_20', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/pages/131092082/metafields.json',
      query: '',
      headers,
  ...
  it('test_21', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/product_images/850703190/metafields.json',
      query: '',
      headers,
  ...
  it('test_22', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/variants/49148385/metafields.json',
      query: '',
      headers,
  ...
  it('test_23', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/products/632910392/metafields.json',
      query: '',
      headers,
      data: { "metafield": {"namespace": "inventory", "key": "warehouse", "value": 25, "type": "number_integer"} }
    }).toMatchMadeHttpRequest();
  ...
  it('test_32', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"count": 7}));
