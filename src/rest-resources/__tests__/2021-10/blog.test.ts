...
describe('Blog resource', () => {
  ...
  it('test_4', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blog": {"id": 1008414255, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2022-03-30T19:45:04-04:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-30T19:45:04-04:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414255"}}));
