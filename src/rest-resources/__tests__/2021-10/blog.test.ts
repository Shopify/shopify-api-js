...
describe('Blog resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/blogs.json',
      query: '',
      headers,
      data: null
  ...
  it('test_2', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blogs": [{"id": 382285388, "handle": "banana-blog", "title": "A Gnu Blog", "updated_at": "2006-02-02T19:00:00-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:52:46-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/382285388"}, {"id": 1008414254, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2022-03-11T10:56:47-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:56:47-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414254"}]}));
  ...
  it('test_3', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blog": {"id": 1008414250, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2022-03-11T10:56:23-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:56:23-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414250"}}));
  ...
  it('test_4', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blog": {"id": 1008414251, "handle": "apple-main-blog", "title": "Apple main blog", "updated_at": "2022-03-11T10:56:25-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:56:25-05:00", "template_suffix": null, "tags": "", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/1008414251"}}));
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/blogs/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/blogs/241253187.json',
  ...
  it('test_8', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blog": {"title": "IPod Updates", "handle": "apple-blog", "id": 241253187, "updated_at": "2022-03-11T10:56:29-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:52:46-05:00", "template_suffix": null, "tags": "Announcing, Mystery", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/241253187"}}));
  ...
  it('test_9', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blog": {"title": "IPod Updates", "handle": "ipod-updates", "commentable": "moderate", "id": 241253187, "updated_at": "2022-03-11T10:56:30-05:00", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:52:46-05:00", "template_suffix": null, "tags": "Announcing, Mystery", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/241253187"}}));
  ...
  it('test_10', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"blog": {"title": "Mah Blog", "handle": "apple-blog", "id": 241253187, "updated_at": "2022-03-11T10:56:31-05:00", "commentable": "no", "feedburner": null, "feedburner_location": null, "created_at": "2022-03-11T10:52:46-05:00", "template_suffix": null, "tags": "Announcing, Mystery", "admin_graphql_api_id": "gid://shopify/OnlineStoreBlog/241253187"}}));
