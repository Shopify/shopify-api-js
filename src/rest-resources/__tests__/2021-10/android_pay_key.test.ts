...
import {AndroidPayKey} from '../../2021-10';
...
describe('AndroidPayKey resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/android_pay_keys.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/android_pay_keys/964811897.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2021-10/android_pay_keys/964811898.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
