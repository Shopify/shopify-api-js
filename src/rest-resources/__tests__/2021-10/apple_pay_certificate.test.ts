...
import {ApplePayCertificate} from '../../2021-10';
...
describe('ApplePayCertificate resource', () => {
  ...
  it('test_1', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"apple_pay_certificate": {"id": 1068938278, "status": "issuing", "merchant_id": null}}));
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/apple_pay_certificates.json',
      query: '',
      headers,
  ...
  it('test_2', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"apple_pay_certificate": {"id": 1068938274, "status": "csr", "merchant_id": null}}));
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/apple_pay_certificates/1068938274.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_3', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"apple_pay_certificate": {"id": 1068938276, "status": "completed", "merchant_id": "merchant.something"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-10/apple_pay_certificates/1068938276.json',
      query: '',
      headers,
      data: { "apple_pay_certificate": {"id": 1068938276, "status": "completed", "merchant_id": "merchant.something", "encoded_signed_certificate": "\nKoZIzj0CAQYIKoZIzj0DAQcDQgAEAxDDCvzG6MnsZSJOtbr0hr3MRq 4HzTZ\\nhvdjZAUBMIH MIHDBggrBgEFBQcCAjCBtgyBs1JlbGlhbmNlIG9uIHRoaXMg\\nNKpVyn3t\n"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2021-10/apple_pay_certificates/1068938277.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/apple_pay_certificates/1068938275/csr.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
