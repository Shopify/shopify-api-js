...
import {Transaction} from '../../2021-10';
...
describe('Transaction resource', () => {
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/orders/450789469/transactions/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/orders/450789469/transactions/389404469.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
