...
describe('Order resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/orders.json',
      query: 'status=any',
      headers,
      data: null
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/orders/450789469.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_19', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/orders/count.json',
      query: 'status=any',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_21', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/orders/450789469/close.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_22', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/orders/450789469/open.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_23', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/orders/450789469/cancel.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
