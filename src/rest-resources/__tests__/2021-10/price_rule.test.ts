...
describe('PriceRule resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/price_rules.json',
      query: '',
      headers,
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-10/price_rules/507328175.json',
      query: '',
      headers,
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/price_rules/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
