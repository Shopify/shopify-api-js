...
import {Fulfillment} from '../../2021-10';
...
describe('Fulfillment resource', () => {
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/fulfillment_orders/1046000783/fulfillments.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/fulfillments/1069019867/update_tracking.json',
      query: '',
      headers,
