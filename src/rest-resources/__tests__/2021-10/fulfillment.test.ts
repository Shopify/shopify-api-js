...
describe('Fulfillment resource', () => {
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/fulfillment_orders/1046000781/fulfillments.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_21', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/fulfillments/1069019881/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_25', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-10/fulfillments/1069019882/cancel.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
