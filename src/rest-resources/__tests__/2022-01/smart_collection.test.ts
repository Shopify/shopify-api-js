...
describe('SmartCollection resource', () => {
  ...
  it('test_1', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collections": [{"id": 482865238, "handle": "smart-ipods", "title": "Smart iPods", "updated_at": "2008-02-01T19:00:00-05:00", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2022-03-30T19:20:40-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1648682440"}}]}));
  ...
  it('test_2', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collections": [{"id": 1063001323, "handle": "ipods-1", "title": "IPods", "updated_at": "2022-03-30T19:21:41-04:00", "body_html": null, "published_at": "2022-03-30T19:21:41-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "title", "relation": "starts_with", "condition": "iPod"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001323"}]}));
  ...
  it('test_4', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collections": [{"id": 1063001324, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-03-30T19:21:45-04:00", "body_html": null, "published_at": "2022-03-30T19:21:45-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001324"}, {"id": 482865238, "handle": "smart-ipods", "title": "Smart iPods", "updated_at": "2008-02-01T19:00:00-05:00", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2022-03-30T19:20:40-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1648682440"}}]}));

    await SmartCollection.all({
      session: test_session,
      ids: "482865238,1063001324",
    });
    ...
    expect({
      ...
      domain,
      path: '/admin/api/2022-01/smart_collections.json',
      query: 'ids=482865238%2C1063001324',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_5', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001325, "handle": "ipods-1", "title": "IPods", "updated_at": "2022-03-30T19:21:50-04:00", "body_html": null, "published_at": "2022-03-30T19:21:50-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "title", "relation": "starts_with", "condition": "iPod"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001325"}}));
  ...
  it('test_6', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001326, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-03-30T19:21:51-04:00", "body_html": null, "published_at": "2022-03-30T19:21:51-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001326"}}));
  ...
  it('test_7', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001327, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-03-30T19:21:52-04:00", "body_html": null, "published_at": null, "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001327"}}));
  ...
  it('test_8', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001328, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-03-30T19:21:54-04:00", "body_html": null, "published_at": "2022-03-30T19:21:53-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001328", "image": {"created_at": "2022-03-30T19:21:54-04:00", "alt": "iPod", "width": 1, "height": 1, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/df3e567d6f16d040326c7a0ea29a4f41.gif?v=1648682514"}}}));
  ...
  it('test_9', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001329, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-03-30T19:21:57-04:00", "body_html": null, "published_at": "2022-03-30T19:21:55-04:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001329", "image": {"created_at": "2022-03-30T19:21:56-04:00", "alt": "Rails Logo", "width": 110, "height": 140, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20220330-52626-3fob1y.gif?v=1648682517"}}}));
  ...
  it('test_14', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "id": 482865238, "published_at": "2022-03-30T19:22:00-04:00", "updated_at": "2022-03-30T19:22:00-04:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2022-03-30T19:20:40-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1648682440"}}}));
  ...
  it('test_15', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "id": 482865238, "published_at": null, "updated_at": "2022-03-30T19:22:02-04:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2022-03-30T19:20:40-04:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1648682440"}}}));
  ...
  it('test_16', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"updated_at": "2022-03-30T19:22:05-04:00", "id": 482865238, "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2022-03-30T19:22:05-04:00", "alt": "Rails logo", "width": 110, "height": 140, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1648682525"}}}));
  ...
  it('test_17', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"updated_at": "2022-03-30T19:22:09-04:00", "id": 482865238, "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"alt": "Rails logo", "created_at": "2022-03-30T19:22:08-04:00", "width": 110, "height": 140, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20220330-52626-1jxzxf.gif?v=1648682529"}}}));
  ...
  it('test_18', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "smart_collection": {"id": 482865238, "image": "", "updated_at": "2022-03-30T19:22:11-04:00", "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238"} }
    }).toMatchMadeHttpRequest();
  });
