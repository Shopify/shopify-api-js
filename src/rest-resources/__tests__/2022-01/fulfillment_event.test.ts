...
describe('FulfillmentEvent resource', () => {
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2022-01/orders/450789469/fulfillments/255858046/events/944956395.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2022-01/orders/450789469/fulfillments/255858046/events/944956397.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
