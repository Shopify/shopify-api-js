...
import {CustomCollection} from '../../2021-07';
...
describe('CustomCollection resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/custom_collections.json',
      query: '',
      headers,
      data: null
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/custom_collections/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/custom_collections/841564295.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
