...
import {Transaction} from '../../2021-07';
...
describe('Transaction resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/orders/450789469/transactions.json',
      query: '',
      headers,
      data: null
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/orders/450789469/transactions/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/orders/450789469/transactions/389404469.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
