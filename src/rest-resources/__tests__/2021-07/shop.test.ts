...
describe('Shop resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/shop.json',
      query: '',
      headers,
      data: null
