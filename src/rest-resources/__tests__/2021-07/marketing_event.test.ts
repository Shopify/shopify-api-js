...
import {MarketingEvent} from '../../2021-07';
...
describe('MarketingEvent resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/marketing_events.json',
      query: '',
      headers,
      data: null
  ...
  it('test_2', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"marketing_event": {"id": 1065859216, "event_type": "ad", "remote_id": null, "started_at": "2022-12-15T00:00:00-05:00", "ended_at": null, "scheduled_to_end_at": null, "budget": null, "currency": null, "manage_url": null, "preview_url": null, "utm_campaign": "Christmas2022", "utm_source": "facebook", "utm_medium": "cpc", "budget_type": null, "description": null, "marketing_channel": "social", "paid": true, "referring_domain": "facebook.com", "breadcrumb_id": null, "marketing_activity_id": 1063897333, "admin_graphql_api_id": "gid://shopify/MarketingEvent/1065859216", "marketed_resources": []}}));
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/marketing_events/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-07/marketing_events/998730532.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-07/marketing_events/998730532/engagements.json',
      query: '',
      headers,
