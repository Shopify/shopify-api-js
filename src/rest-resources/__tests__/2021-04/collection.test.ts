...
import {Collection} from '../../2021-04';
...
describe('Collection resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/collections/841564295.json',
      query: '',
      headers,
      data: null
  ...
  it('test_2', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/collections/841564295/products.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
