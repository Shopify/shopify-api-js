...
import {DraftOrder} from '../../2021-04';
...
describe('DraftOrder resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/draft_orders.json',
      query: '',
      headers,
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-04/draft_orders/994118539.json',
      query: '',
      headers,
  ...
  it('test_11', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/draft_orders/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/draft_orders/994118539/send_invoice.json',
      query: '',
      headers,
  ...
  it('test_14', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-04/draft_orders/994118539/complete.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
