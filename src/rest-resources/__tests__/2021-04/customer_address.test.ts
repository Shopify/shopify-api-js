...
import {CustomerAddress} from '../../2021-04';
...
describe('CustomerAddress resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers/207119551/addresses.json',
      query: '',
      headers,
      data: null
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers/207119551/addresses/207119551.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2021-04/customers/207119551/addresses/1053317335.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-04/customers/207119551/addresses/set.json',
  ...
  it('test_8', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-04/customers/207119551/addresses/1053317337/default.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
