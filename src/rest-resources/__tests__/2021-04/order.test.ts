...
describe('Order resource', () => {
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/orders/450789469.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_17', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "order": {id: 450789469, metafields: [{key: "new", value: "newvalue", value_type: "string", namespace: "global"}]} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_19', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/orders/count.json',
      query: 'status=any',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_21', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/orders/450789469/close.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_22', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/orders/450789469/open.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_23', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/orders/450789469/cancel.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
