...
import {StorefrontAccessToken} from '../../2021-04';
...
describe('StorefrontAccessToken resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/storefront_access_tokens.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'DELETE',
      domain,
      path: '/admin/api/2021-04/storefront_access_tokens/755357713.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
