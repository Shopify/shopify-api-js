...
import {UsageCharge} from '../../2021-04';
...
describe('UsageCharge resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/recurring_application_charges/455696195/usage_charges.json',
      query: '',
      headers,
  ...
  it('test_3', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/recurring_application_charges/455696195/usage_charges/1034618217.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
