...
describe('Customer resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers.json',
      query: '',
      headers,
      data: null
  ...
  it('test_9', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers/search.json',
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers/207119551.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_14', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "customer": {"id": 207119551, "accepts_marketing": true, "accepts_marketing_updated_at": "2022-03-05T11:18:55-05:00", "marketing_opt_in_level": "confirmed_opt_in"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/customers/207119551/account_activation_url.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_16', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/customers/207119551/send_invite.json',
      query: '',
      headers,
  ...
  it('test_18', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_19', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customers/207119551/orders.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
