...
describe('ScriptTag resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/script_tags.json',
      query: '',
      headers,
      data: null
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/script_tags/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/script_tags/596726825.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
