...
describe('Country resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/countries.json',
      query: '',
      headers,
      data: null
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/countries/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/countries/879921427.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
