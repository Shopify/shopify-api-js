...
import {SmartCollection} from '../../2021-04';
...
describe('SmartCollection resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/smart_collections.json',
      query: '',
      headers,
      data: null
  ...
  it('test_4', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collections": [{"id": 1063001375, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-02-03T17:04:12-05:00", "body_html": null, "published_at": "2022-02-03T17:04:12-05:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001375"}, {"id": 482865238, "handle": "smart-ipods", "title": "Smart iPods", "updated_at": "2008-02-01T19:00:00-05:00", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238", "image": {"created_at": "2022-02-03T16:53:36-05:00", "alt": "MP3 Player 8gb", "width": 123, "height": 456, "src": "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1643925216"}}]}));

    await SmartCollection.all({
      session: test_session,
      ids: "482865238,1063001375",
    });
    ...
    expect({
      ...
      domain,
      path: '/admin/api/2021-04/smart_collections.json',
      query: 'ids=482865238%2C1063001375',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_6', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001377, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-02-03T17:04:22-05:00", "body_html": null, "published_at": "2022-02-03T17:04:22-05:00", "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001377"}}));
  ...
  it('test_7', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"smart_collection": {"id": 1063001378, "handle": "macbooks", "title": "Macbooks", "updated_at": "2022-02-03T17:04:23-05:00", "body_html": null, "published_at": null, "sort_order": "best-selling", "template_suffix": null, "disjunctive": false, "rules": [{"column": "vendor", "relation": "equals", "condition": "Apple"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/1063001378"}}));
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/smart_collections/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_12', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/smart_collections/482865238.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_18', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "smart_collection": {"id": 482865238, "image": "", "updated_at": "2022-02-03T17:04:39-05:00", "title": "Smart iPods", "handle": "smart-ipods", "body_html": "<p>The best selling ipod ever</p>", "published_at": "2008-02-01T19:00:00-05:00", "sort_order": "manual", "template_suffix": null, "disjunctive": false, "rules": [{"column": "type", "relation": "equals", "condition": "Cult Products"}], "published_scope": "web", "admin_graphql_api_id": "gid://shopify/Collection/482865238"} }
    }).toMatchMadeHttpRequest();
  });
  ...
  it('test_20', async () => {
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-04/smart_collections/482865238/order.json',
