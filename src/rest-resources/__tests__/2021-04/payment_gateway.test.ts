...
import {PaymentGateway} from '../../2021-04';
...
describe('PaymentGateway resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/payment_gateways.json',
      query: '',
      headers,
      data: null
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/payment_gateways/431363653.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_5', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"payment_gateway": {"disabled": false, "id": 170508070, "name": "Cash on Delivery (COD)", "provider_id": 140, "sandbox": true, "supports_network_tokenization": null, "type": "ManualPaymentGateway", "enabled_card_brands": [], "processing_method": "manual", "service_name": "Cash on Delivery (COD)", "metadata": {}, "created_at": "2022-02-03T17:14:40-05:00", "updated_at": "2022-02-03T17:15:17-05:00"}}));
    ...
    expect({
      method: 'PUT',
      domain,
      path: '/admin/api/2021-04/payment_gateways/170508070.json',
      query: '',
      headers,
