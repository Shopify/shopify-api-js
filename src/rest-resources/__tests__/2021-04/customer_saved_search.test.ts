...
import {CustomerSavedSearch} from '../../2021-04';
...
describe('CustomerSavedSearch resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customer_saved_searches.json',
      query: '',
      headers,
      data: null
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customer_saved_searches/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customer_saved_searches/789629109.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/customer_saved_searches/789629109/customers.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
