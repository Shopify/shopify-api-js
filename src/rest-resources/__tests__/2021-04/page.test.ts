...
describe('Page resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/pages.json',
      query: '',
      headers,
      data: null
  ...
  it('test_3', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"page": {"id": 1025371369, "title": "Warranty information", "shop_id": 548380009, "handle": "warranty-information", "body_html": "<h2>Warranty</h2>\n<p>Returns accepted if we receive items <strong>30 days after purchase</strong>.</p>", "author": "Shopify API", "created_at": "2022-02-08T14:49:29-05:00", "updated_at": "2022-02-08T14:49:29-05:00", "published_at": "2022-02-08T14:49:29-05:00", "template_suffix": null, "admin_graphql_api_id": "gid://shopify/OnlineStorePage/1025371369"}}));
  ...
  it('test_4', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"page": {"id": 1025371370, "title": "Warranty information", "shop_id": 548380009, "handle": "warranty-information", "body_html": "<h2>Warranty</h2>\n<p>Returns accepted if we receive items <strong>30 days after purchase</strong>.</p>", "author": "Shopify API", "created_at": "2022-02-08T14:49:30-05:00", "updated_at": "2022-02-08T14:49:30-05:00", "published_at": null, "template_suffix": null, "admin_graphql_api_id": "gid://shopify/OnlineStorePage/1025371370"}}));
  ...
  it('test_5', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"page": {"id": 1025371371, "title": "Warranty information", "shop_id": 548380009, "handle": "warranty-information", "body_html": "<h2>Warranty</h2>\n<p>Returns accepted if we receive items <strong>30 days after purchase</strong>.</p>", "author": "Shopify API", "created_at": "2022-02-08T14:49:33-05:00", "updated_at": "2022-02-08T14:49:33-05:00", "published_at": "2022-02-08T14:49:33-05:00", "template_suffix": null, "admin_graphql_api_id": "gid://shopify/OnlineStorePage/1025371371"}}));
  ...
  it('test_6', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/pages/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/pages/131092082.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_8', async () => {
    fetchMock.mockResponseOnce(JSON.stringify({"page": {"shop_id": 548380009, "body_html": "<p>Returns accepted if we receive the items 14 days after purchase.</p>", "title": "Terms of Services", "handle": "tos", "id": 131092082, "author": "Dennis", "created_at": "2008-07-15T20:00:00-04:00", "updated_at": "2022-02-08T14:49:41-05:00", "published_at": "2008-07-15T20:00:00-04:00", "template_suffix": null, "admin_graphql_api_id": "gid://shopify/OnlineStorePage/131092082"}}));
  ...
  it('test_12', async () => {
    ...
    expect({
      ...
      query: '',
      headers,
      data: { "page": {"id": 131092082, "metafields": [{"key": "new", "value": "new value", "value_type": "string", "namespace": "global"}]} }
    }).toMatchMadeHttpRequest();
  });
