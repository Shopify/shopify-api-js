...
import {Fulfillment} from '../../2021-04';
...
describe('Fulfillment resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/orders/450789469/fulfillments.json',
      query: '',
      headers,
      data: null
  ...
  it('test_15', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/fulfillment_orders/1046000859/fulfillments.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_16', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/orders/450789469/fulfillments/count.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_17', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-04/orders/450789469/fulfillments/255858046.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_19', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/fulfillments.json',
      query: '',
      headers,
  ...
  it('test_21', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/fulfillments/1069019908/update_tracking.json',
      query: '',
      headers,
  ...
  it('test_22', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/orders/450789469/fulfillments/255858046/complete.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_23', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/orders/450789469/fulfillments/255858046/open.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_24', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/orders/450789469/fulfillments/255858046/cancel.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
  ...
  it('test_25', async () => {
    ...
    expect({
      method: 'POST',
      domain,
      path: '/admin/api/2021-04/fulfillments/1069019909/cancel.json',
      query: '',
      headers,
      data: null
    }).toMatchMadeHttpRequest();
