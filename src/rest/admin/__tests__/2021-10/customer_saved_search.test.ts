...
describe('CustomerSavedSearch resource', () => {
  ...
  it('test_1', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/customer_saved_searches.json',
      query: '',
      headers,
      data: undefined
  ...
  it('test_5', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/customer_saved_searches/count.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_7', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/customer_saved_searches/789629109.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
  ...
  it('test_10', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/customer_saved_searches/789629109/customers.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
