...
describe('CarrierService resource', () => {
  ...
  it('test_4', async () => {
    ...
    expect({
      method: 'GET',
      domain,
      path: '/admin/api/2021-10/carrier_services/1036894956.json',
      query: '',
      headers,
      data: undefined
    }).toMatchMadeHttpRequest();
