...
describe('MobilePlatformApplication resource', () => {
  ...
  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066175998, "application_id": "X1Y2.ca.domain.app", "platform": "ios", "created_at": "2022-04-05T12:53:43-04:00", "updated_at": "2022-04-05T12:53:43-04:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true}}));
  ...
  it('test_4', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"id": 1066176000, "application_id": "X1Y2.ca.domain.app", "platform": "ios", "created_at": "2022-04-05T12:53:44-04:00", "updated_at": "2022-04-05T12:53:44-04:00", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true}}));
  ...
  it('test_5', async () => {
    queueMockResponse(JSON.stringify({"mobile_platform_application": {"application_id": "A1B2.ca.domain.app", "platform": "ios", "sha256_cert_fingerprints": [], "enabled_universal_or_app_links": true, "enabled_shared_webcredentials": true, "id": 1066176001, "created_at": "2022-04-05T12:53:45-04:00", "updated_at": "2022-04-05T12:53:47-04:00"}}));
