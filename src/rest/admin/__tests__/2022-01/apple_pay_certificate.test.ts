...
describe('ApplePayCertificate resource', () => {
  ...
  it('test_1', async () => {
    queueMockResponse(JSON.stringify({"apple_pay_certificate": {"id": 1068938279, "status": "issuing", "merchant_id": null}}));
  ...
  it('test_2', async () => {
    queueMockResponse(JSON.stringify({"apple_pay_certificate": {"id": 1068938280, "status": "csr", "merchant_id": null}}));
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"apple_pay_certificate": {"id": 1068938282, "status": "completed", "merchant_id": "merchant.something"}}));
