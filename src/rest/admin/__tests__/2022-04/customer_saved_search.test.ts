...
describe('CustomerSavedSearch resource', () => {
  ...
  it('test_3', async () => {
    queueMockResponse(JSON.stringify({"customer_saved_search": {"id": 1068136102, "name": "Spent more than $50", "created_at": "2022-03-11T10:53:32-05:00", "updated_at": "2022-03-11T10:53:32-05:00", "query": "total_spent:>50"}}));
  ...
  it('test_4', async () => {
    queueMockResponse(JSON.stringify({"customer_saved_search": {"id": 1068136103, "name": "Spent more than $50 and after 2013", "created_at": "2022-03-11T10:53:34-05:00", "updated_at": "2022-03-11T10:53:34-05:00", "query": "total_spent:>50 order_date:>=2013-01-01"}}));
  ...
  it('test_7', async () => {
    queueMockResponse(JSON.stringify({"customer_saved_search": {"id": 789629109, "name": "Accepts Marketing", "created_at": "2022-03-04T10:52:46-05:00", "updated_at": "2022-03-04T10:52:46-05:00", "query": "accepts_marketing:1"}}));
  ...
  it('test_8', async () => {
    queueMockResponse(JSON.stringify({"customer_saved_search": {"name": "This Name Has Been Changed", "id": 789629109, "created_at": "2022-03-04T10:52:46-05:00", "updated_at": "2022-03-11T10:53:35-05:00", "query": "accepts_marketing:1"}}));
